...
This package provides **CoinSpot exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **COINSPOT** exchange.
...
```
bt_api_coinspot/
├── src/bt_api_coinspot/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_coinspot/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **CoinSpot exchange plugin for bt_api**。它提供了与 **COINSPOT** 交易所交互的统一接口。
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_coinspot/issues) 反馈问题
